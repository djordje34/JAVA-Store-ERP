...
@Service
public class AdvancedGoodsService {
    ...
    @Autowired
    public AdvancedGoodsService(ProductRepository productRepository, InventoryItemRepository inventoryItemRepository, WarehouseRepository warehouseRepository, RabbitTemplate rabbitTemplate) {
